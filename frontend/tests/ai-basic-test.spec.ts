...
test.describe('AI Services - Basic Gemini Test', () => {
  ...
  test('should check AI poster service status', async ({ request }) => {
    ...
    console.log('✅ AI Poster Service is available');
  });

  test('should generate a simple poster with timeout handling', async ({ request }) => {
    const testData = {
