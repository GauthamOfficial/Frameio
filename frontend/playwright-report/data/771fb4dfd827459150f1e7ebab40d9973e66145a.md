...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e88]
  - generic [ref=e89]:
    - button "Missing environment keys" [expanded] [ref=e90]:
      - generic [ref=e91]:
        - img [ref=e92]
        - paragraph [ref=e94] [cursor=pointer]: Missing environment keys
    - generic [ref=e95]:
      - region "Missing environment keys" [ref=e96]:
        - paragraph [ref=e97]: You claimed this application but haven't set keys in your environment. Get them from the Clerk Dashboard.
      - link "Get API keys" [ref=e99] [cursor=pointer]:
